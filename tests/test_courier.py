...
class TestCourier:
    ...
    @allure.step('Региструем курьера с полным набором данных')
    ...
    @allure.step('Регистрация курьера с повторяющимся логином')
    ...
    @allure.step('Регистрация курьера с неполными обязательными полями')
    ...
    @allure.step('Авторизация курьера с реальными данными')
